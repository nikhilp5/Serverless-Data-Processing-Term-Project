      ...
      .then((result) => {
        ...
        const updatedQuestions = questions.map((question) => {
          if (question.questionID === questionId) {
            return { ...newQuestion, questionID: question.questionID };
          }
          return question;
        });
    ...
    <Container style={containerStyle}>
      ...
      <TableContainer component={Paper} style={tableContainerStyle}>
        <Table>
          ...
          <TableBody>
            {questions
              .slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage) // Apply pagination to the displayed rows
              .map((question) => (
      ...
      <Dialog open={isAddModalOpen} onClose={handleAddModalClose}>
        ...
        <DialogContent>
          ...
          <TextField
            ...
            onChange={(e) =>
              handleNewQuestionChange("difficultyLevel", e.target.value)
            }
            style={{ marginBottom: "8px" }}
          />
          {/* <TextField
        ...
        <DialogActions>
          ...
          <Button onClick={handleAddQuestion} disabled={!newQuestion.question}>
            Add
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog open={isEditModalOpen} onClose={handleEditModalClose}>
        ...
        <DialogActions>
          ...
          <Button
            onClick={() => handleUpdateQuestion(selectedQuestion.questionID)}
